...
###Add Private fund (remain after locked in vesting pool)
##linear unlock first
export FUND_PRIVATE_VESTING_TYPE=3
##5%
export FUND_PRIVATE_UNLOCK_PERCENT=500
##2 months
export FUND_PRIVATE_CLIFF=5184000000
##15 months
export FUND_PRIVATE_VESTING_DUR_MS=38880000000

#export FUND_PRIVATE_WALLET=0x4335958e123b9504e023e58c4630a817d5a17f1334e51cba5c99f3d130799c4c

##?? SPT
#export FUND_PRIVATE_SPT=0x29c9d045ac5be1e39dc01d05a584aaceb778790a4cd841baee29619e332b079c
#sui client call --gas-budget 200000000 --package $PACKAGE --module "tokenomic_entries" --function "addFund"  --type-args $SPT_TYPE --args $ADMIN_CAP $PIE $FUND_PRIVATE_WALLET "FUND PRIVATE" $FUND_PRIVATE_VESTING_TYPE $TGE_MS $FUND_PRIVATE_CLIFF $FUND_PRIVATE_SPT $FUND_PRIVATE_UNLOCK_PERCENT $FUND_PRIVATE_VESTING_DUR_MS $CLOCK $VERSION [] []
