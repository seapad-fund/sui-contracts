...
module seapad::tokenomic_test {
    ...
    // const TOTAL_SUPPLY: u128 = 100000000;
    ...
    fun init_fund_for_test<COIN>(_admin: &TAdminCap,
        ...
        addFund(_admin,
            ...
            tge_ms,
            0,
            coin::mint_for_testing<COIN>(((TOTAL_SUPPLY / 10) as u64), ctx),
            500,
            18 * MONTH_IN_MS,
            sclock,
            version,
        ...
        addFund(_admin,
            ...
            tge_ms,
            1 * MONTH_IN_MS,
            coin::mint_for_testing(((TOTAL_SUPPLY * 12 / 100) as u64), ctx),
            1000,
            12 * MONTH_IN_MS,
            sclock,
            version,
    ...
    #[test]
    #[expected_failure(abort_code = seapad::tokenomic::ERR_TGE_NOT_STARTED)]
    ...
    #[test]
    #[expected_failure(abort_code = seapad::tokenomic::ERR_NO_COIN)]
    ...
    fun test_unlock_first_cliff_zero_claim_nomore2() {
        ...
        assert!(
            tokenomic::getFundVestingAvailable(&pie, @seedFund) == TOTAL_SUPPLY / 10 - (500 + 9500 / 2) * TOTAL_SUPPLY / 100000,
            1
        );
