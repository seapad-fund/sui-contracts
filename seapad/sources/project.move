...
module seapad::project {
    ...
    public fun create_project<COIN>(_adminCap: &AdminCap,
        ...
        let launchstate = LaunchState<COIN> {
            ...
            coin_raised: option::none<Coin<SUI>>(),
    ...
    public fun start_fund_raising<COIN>(
        _adminCap: &AdminCap,
        project: &mut Project<COIN>,
        clock: &Clock,
        ctx: &mut TxContext
    ...
    public fun end_fund_raising<COIN>(
        _adminCap: &AdminCap,
        project: &mut Project<COIN>,
        clock: &Clock,
        ctx: &mut TxContext
    ...
    public fun claim_token<COIN>(project: &mut Project<COIN>, clock: &Clock, ctx: &mut TxContext) {
    ...
    fun swap_token<COIN>(coin_value: u64, project: &Project<COIN>): u64 {
    ...
    fun validate_state_for_buy<COIN>(project: &mut Project<COIN>, senderAddr: address, now: u64) {
    ...
    fun validate_end_fund_rasing<COIN>(project: &mut Project<COIN>) {
        assert!(project.launch_state.state == ROUND_STATE_RASING, EInvalidRoundState);
    }
